...
export const ThoughtsSection: React.FC = () => {
	...
	return (
		<section
			id='blog'
			className='py-16 sm:py-28 px-4 sm:px-8 md:px-16 max-w-7xl mx-auto border-t border-[var(--subtle-border)]'>
			{/* Header */}
			<div className='flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10 sm:mb-16'>
				<div>
					<h2 className='text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter'>0x01_THOUGHTS</h2>
						...
						return (
							<article
								...
								<div className='absolute inset-0 z-0 overflow-hidden'>
									<img
										src={entry.imageUrl}
										alt={`Editorial cover image for ${entry.title}`}
							...
							<a
								...
								<div className='absolute inset-0 z-0 overflow-hidden'>
									<img
										src={entry.imageUrl}
										alt={`Editorial cover image for ${entry.title}`}
										className='w-full h-full object-cover scale-110 group-hover:scale-125 transition-transform duration-700 ease-out opacity-40 group-hover:opacity-60'
									/>
