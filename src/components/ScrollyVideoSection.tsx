...
const STORY_CARDS = [
	{
		...
		description:
			"John McCarthy posits computation delivered as a public utility. Early mainframes lay the conceptual seeds for time-sharing systems and remote terminal access.",
	...
	},
	{
		...
		description:
			"Salesforce pioneers application delivery over HTTP. Enterprise software migrates from local disks to multi-tenant cloud servers across global fiber networks.",
	...
	},
	{
		...
		description:
			"AWS introduces EC2 and S3. Hardware transitions from physical server racks into programmable, elastic API primitives available at penny scale.",
		code: "PAR-03_AWS_EC2",
	...
	},
	{
		...
		description:
			"Kubernetes standardizes containerized microservices. Applications break free from fixed infrastructure into dynamic, self-healing cluster meshes.",
	...
	},
	{
		...
		description:
			"Cloud datacenters evolve into multi-gigawatt AI supercomputers. Massive GPU clusters drive trillion-parameter transformer models and real-time reasoning.",
	...
	},
	{
		...
		description:
			"Self-governing LLM agents manage cloud topologies, auto-remediating orphaned assets, rightsizing compute pods, and optimizing cost jitter in real time.",
	...
	},
	{
		...
		description:
			"Hybrid quantum-classical cloud backbones solve cryptographic, chemical, and climate simulation limits beyond the reach of silicon transistors.",
		code: "PAR-07_QUANTUM",
	...
	},
	{
		...
		description:
			"Orbital solar arrays and planetary fusion compute nodes power interstellar AI reasoning, cementing compute as the central currency of civilization.",
		code: "PAR-08_TYPE_I",
...
const StoryCard: React.FC<StoryCardProps> = ({ index, title, year, subtitle, description, code, coordinates }) => {
				...
				<div className='max-w-7xl mx-auto px-6 sm:px-8 md:px-12'>
					...
					<div className='mb-[25vh] max-w-xl font-mono-tech'>
						...
						<p className='font-sans text-xs sm:text-sm leading-relaxed text-[var(--text-secondary)] font-normal'>
							Tracing the trajectory from primitive mainframe utility computing to hyperscale AI backbones, quantum mesh
							infrastructure, and planetary compute energy harvesting.
						</p>
					</div>
